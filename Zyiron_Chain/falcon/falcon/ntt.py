...
"""
from Zyiron_Chain.falcon.falcon.common import split, merge, q                     # Import split and merge
from Zyiron_Chain.falcon.falcon.ntt_constants import roots_dict_Zq, inv_mod_q     # Import constants useful for the FFT
